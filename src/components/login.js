                ...
                <div style={{width:"100%"}}>
                    ...
                    <form onSubmit={handleSubmit} className="loginInfo">
                        ...
                        <input type="password"  className="form-control frms" name="password" value={password} placeholder="Enter Password"  
                         onChange={handleChange} required></input><br/>
                        <button type = "submit" className="btn btn-success btn-lg btn-block logInBtn">Login</button>
                        <button type = "button" onClick={()=>{
                            history.push("/")
                        }} className="btn btn-warning btn-lg btn-block logInBtn">Cancel</button>
                    </form>
                <hr style={{margin:"0px" }}/>
